...
urlpatterns = [
    ...
    url(r"^toggle-play-mode/(?P<token>[\w\-]+)/(?P<toggle>\d+)/$", views.toggle_play_mode_view, name="toggle_play_mode"),
    url(r"^toggle-recording/(?P<token>[\w\-]+)/(?P<toggle>\d+)/$", views.toggle_recording_view, name="toggle_recording"),
